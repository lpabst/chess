  ...
  render() {
    return (
      <div className='settings_div'>
        ...
        <div className='setting_row'>
          <p>Play as </p>
          <select value={this.props.playAs} onChange={(e) => this.props.updateState(e.target.value, 'playAs')} >
            <option>White</option>
            <option>Black</option>
          </select>
        </div>
        ...
        <div className='setting_row'>
          <p>Player 2</p>
          <select value={this.props.player2} onChange={(e) => this.props.updateState(e.target.value, 'player2')} >
...

        {
          this.props.player2 === 'Human' ? 
            <div className='setting_row'>
              <p>Rotate Board</p>
              <select value={this.props.rotateBoard} onChange={(e) => this.props.updateState(e.target.value, 'rotateBoard')} >
                <option>Yes</option>
                <option>No</option>
              </select>
            </div>
